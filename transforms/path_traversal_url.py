...
# Kinds excluded from the traversal. Mirrors the documented default;
# operators with custom shortcut kinds (Tag, Tenant, Vendor, …) can edit
# this list. The main-branch README has a "Tune the excluded kinds" section
# explaining why.
